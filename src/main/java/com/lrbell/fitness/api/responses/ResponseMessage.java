...
public final class ResponseMessage {
    ...
    public static final String USER_NAME_NOT_FOUND = "Username %s not found";
    ...
    public static final String EXERCISE_ID_NOT_FOUND = "Exercise(s) %s not found";
    ...
    public static final String NON_UNIQUE_EXERCISE_NAME = "A exercise with that name already exists";
    public static final String INVALID_MUSCLE_GROUP =  "Invalid muscle group";
    public static final String WORKOUT_ID_NOT_FOUND = "Workout %s not found";
    public static final String WORKOUT_CREATED = "Workout started successfully";
    public static final String WORKOUT_UPDATED = "Workout updated successfully";
    public static final String WORKOUT_ENDED = "Workout ended successfully";
    ...
    public static final String PAYLOAD_VALIDATION_ERROR = "The payload has the following errors: %s";
